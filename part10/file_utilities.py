...
# ToDo 0: Create file_utilities.py and move the Configuration class as well as all file-related functionality from app.py there
...
class Configuration:
    ...
    # ToDo 0: Move save_config into the Configuration class and rename it.
    def save(self) -> None:
