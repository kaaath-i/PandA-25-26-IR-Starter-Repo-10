...
class SearchResult:
    ...
    def ansi_highlight(text: str, spans, highlight_mode: str="DEFAULT"):
        ...
        out = []
        i = 0
        # ToDo 0: Re-Introduce the configuration option for the GREEN highlighting variant and pass it on to the ansi_highlight method.
        for s, e in merged:
            out.append(text[i:s])
...
class SearchEngine:
    ...
    def combine(self, raw, search_mode):
        words = raw.split()
